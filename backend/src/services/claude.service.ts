...
- After order/product display, offer relevant quick replies in a separate follow-up... actually do it in the same message
...
/**
 * Parse action tokens from Claude's raw output.
...
/**
 * Send a message to Claude and get a parsed response.
 */
